...
<body>
			...
			<div class="newform">
				...
				<form action="/GSRationalCar/memberLogin.do" method="post">
					<input type="text" name="id" placeholder="ID" required
						...
						class="form-control input-lg" /><br> <input type="submit"
						name="go" class=" btn btn-lg btn-primary btn-block" value="로그인" />
	...
	<script src="/GSRationalCar/resources/js/llogin.js"></script>
	<!-- 로그인 정보를 처리하는 로컬스토리지 JS, 현재 세션을 유지하는 JSP와 로컬스토리지가 담긴 JS 호환문제로 로컬스토리지를 사용하지 않고 있습니다. -->
</body>
</html>