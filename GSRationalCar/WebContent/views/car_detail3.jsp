...
<body>
    ...
    <div>
        <div style="height: 320px;">
            <div class="gallery">
                <img src="/GSRationalCar/resources/image/mini.PNG" onmouseout="this.src='/GSRationalCar/resources/image/mini.PNG'" onmouseover="this.src='/GSRationalCar/resources/image/mini.gif'">
            </div>
        <div>
            <table id="table1">
                <tr>
